...
GRANT SELECT ON INCV.VWSTDREPORTMEMELGINCNV TO ACTS_APPS;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO ACTS_APPS;

GRANT SELECT ON INCV.VWSTDREPORTMEMELGINCNV TO ACTS_USER;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO ACTS_USER;

GRANT SELECT ON INCV.VWSTDREPORTMEMELGINCNV TO AMEAPP;

GRANT SELECT ON INCV.VWSTDREPORTMEMELGINCNV TO CEAPP;

GRANT SELECT ON INCV.VWSTDREPORTMEMELGINCNV TO CLMFIN;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO CLMFIN;

GRANT SELECT ON INCV.VW_CMMEMBERACTIVITYOCCURRENCE TO CM;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO CM;

GRANT SELECT ON INCV.VW_CMMEMBERACTIVITYOCCURRENCE TO CM_APP;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO CM_APP;

GRANT SELECT ON INCV.VW_CMMEMBERACTIVITYOCCURRENCE TO CM_USER;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO CM_USER;

GRANT SELECT ON INCV.VW_CMMEMBERACTIVITYOCCURRENCE TO COMMENG;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO COMMENG;

GRANT SELECT ON INCV.VW_CMMEMBERACTIVITYOCCURRENCE TO COMMENG_USER;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO COMMENG_USER;

GRANT SELECT ON INCV.VWSTDREPORTMEMELGINCNV TO DM_USER;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON INCV.VWSTDREPORTMEMELGINCNV TO FIXER WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON INCV.VW_CMMEMBERACTIVITYOCCURRENCE TO FIXER WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO FIXER WITH GRANT OPTION;

GRANT SELECT ON INCV.VWSTDREPORTMEMELGINCNV TO INCV_APP;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO INCV_APP;

GRANT SELECT ON INCV.VWSTDREPORTMEMELGINCNV TO INCV_DEV;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO INCV_DEV;

GRANT SELECT ON INCV.VWSTDREPORTMEMELGINCNV TO INCV_DML;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO INCV_DML;

GRANT SELECT ON INCV.VWSTDREPORTMEMELGINCNV TO INCV_READ;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO INCV_READ;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO INCV_USER;

GRANT SELECT ON INCV.VW_CMMEMBERACTIVITYOCCURRENCE TO ODS;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO ODS;

GRANT DELETE, INSERT, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON INCV.VW_CMMEMBERACTIVITYOCCURRENCE TO ODS_DML;

GRANT SELECT ON INCV.VWSTDREPORTMEMELGINCNV TO ODS_READ;

GRANT SELECT ON INCV.VW_CMMEMBERACTIVITYOCCURRENCE TO ODS_READ;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO ODS_READ;

GRANT SELECT ON INCV.VWSTDREPORTMEMELGINCNV TO ODS_USER;

GRANT SELECT ON INCV.VW_CMMEMBERACTIVITYOCCURRENCE TO ODS_USER;

GRANT SELECT ON INCV.VW_MEMBERACTIVITYOCCURRENCE TO ODS_USER;

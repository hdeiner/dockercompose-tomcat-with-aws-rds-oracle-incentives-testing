...
AS                                                      
   OBJECT (MEMBERPLANID NUMBER,                         
           ...
           VENDORSOURCENM VARCHAR2 (30),
		   STATUS                    VARCHAR2(24)-- Q3 Sprint3 added by VJ on 07/10/2014/*Status*/
		   ) 
/
...
AS                                                                
   OBJECT (MEDICALCODE VARCHAR2 (20),                             
           MEDICALCODETYPE VARCHAR2 (200),-- Q3 SPRINT3 MODIFIED BY VJ ON 07/10/2014/*FROM 50 TO 200*/                         
           ...
           CODEVALIDATED             VARCHAR2(1)-- Q3 Sprint3 added by VJ on 07/10/2014/*Code Validated*/
           ) 
/
...
--- To be added medication/substance
);
/
...
AS
  ...
  STATUS                      VARCHAR2(12),
  STATUSDT                    DATE,
  HOMEWORKSTDT                DATE, -- ADDED BY LIBINUS ON 07/17/2014
  HOMEWORKENDDT               DATE, -- ADDED BY LIBINUS ON 07/17/2014
  HOMEWORKVALUE               VARCHAR2(200),    
  HOMEWORKTEXTCD              VARCHAR2(12),
  HOMEWORKCATCD               VARCHAR2(12), -- ADDED BY LIBINUS ON 07/17/2014
...
IS
  ...
  (
    ...
    PopulationFocusTaglist ct_PopulationFocusTag_TAB, -- Added by Poorani on 09/19/2014
    Aetnaemplflg           VARCHAR2 (1)  -- Added by Subbiah on 23/06/2015 for US57873
  )
/
